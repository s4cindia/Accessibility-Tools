...
# ---------------------------------------------------------------------------
DISABLED_FEATURES: set[str] = {"downloadable"}   # placeholder 4 temporarily off
...
_FEATURE_API_PREFIXES = {
    ...
    "delivery":     ["/api/feature/vpat", "/api/feature/delivery-errors",
                     ...
                     "/api/feature/import-digital-asset",
                     "/api/feature/import-alt-text"],
...
def create_app() -> Flask:
    ...
    from dashboards.dashboard1_merge import merge_axe_bp
    from dashboards.dashboard2_axe2audit import axe_to_excel_bp
    from dashboards.dashboard4_downloadable import downloadable_bp
    from dashboards.dashboard3_delivery import vpat_report_bp
    from dashboards.dashboard5_vpat import vpat_editor_bp
